...
// Optionally, extend BaseChunk to include a color property
// interface BaseChunkWithColor extends BaseChunk { color?: string; }
...
const SuggestionsList: React.FC<SuggestionsListProps> = ({ suggestions, onSelect }) => (
  <ul className="absolute z-10 w-full mt-1 bg-white border rounded-lg shadow-lg max-h-60 overflow-y-auto">
    {suggestions.map((suggestion, index) => {
      // Use chunk.color if present, otherwise fallback to a default
