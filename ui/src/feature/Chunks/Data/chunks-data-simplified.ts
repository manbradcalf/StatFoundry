...
import { generatePositionChunks, generateEntityRelationshipChunks, generatePlayerInfoChunks } from "./entity-chunk-generators";
import { generatePlayerGameConstraints, generatePlayerSeasonConstraints } from "./game-constraint-generators";
...
const PASSING_SEASON_CHUNKS = generateStatChunks(PASSING_STATS, "season", SlotType.SelectPassingStats);
const PASSING_GAME_CHUNKS = generateStatChunks(PASSING_STATS, "game", SlotType.SelectPassingStats);

const RUSHING_SEASON_CHUNKS = generateStatChunks(RUSHING_STATS, "season", SlotType.SelectFlexStatsSeason);
const RUSHING_GAME_CHUNKS = generateStatChunks(RUSHING_STATS, "game", SlotType.SelectFlexStatsGame);

const RECEIVING_SEASON_CHUNKS = generateStatChunks(RECEIVING_STATS, "season", SlotType.SelectFlexStatsSeason);
const RECEIVING_GAME_CHUNKS = generateStatChunks(RECEIVING_STATS, "game", SlotType.SelectFlexStatsGame);
