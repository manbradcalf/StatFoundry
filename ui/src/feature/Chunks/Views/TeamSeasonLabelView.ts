export const TEAMSEASON_LABEL_PROPERTIES = [  { key: "season", type: "Long" },
  ...
  { key: "epa_defense_rank", type: "Long" },
  ...
  { key: "offensive_epa_allowed_per_game", type: "Double" },
  { key: "pass_yards_allowed_per_game", type: "Double" },
  { key: "def_sacks", type: "Long" },
  { key: "fumble_recovery_own", type: "Long" },
  { key: "pass_offense_rank", type: "Long" },
  { key: "def_sack_yards", type: "Double" },
  { key: "fg_blocked_list", type: "StringArray" },
  { key: "pass_epa_offense_rank", type: "Long" },
  { key: "fg_missed_30_39", type: "Long" },
  { key: "pass_yards_allowed", type: "Double" },
  { key: "fg_missed_20_29", type: "Long" },
  { key: "total_defense_rank", type: "Long" },
  { key: "rush_epa_offense_rank", type: "Long" },
  ...
  { key: "rush_yards_allowed", type: "Double" },
  { key: "rush_yards_allowed_per_game", type: "Double" },
  ...
  { key: "total_yards_allowed_per_game", type: "Double" },
...
export interface TeamSeasonProperties {
  season: number;
  season_type: string;
  completions: number;
  attempts: number;
